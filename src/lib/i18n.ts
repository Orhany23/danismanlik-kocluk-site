...
export const dictionaries: Record<Locale, Dictionary> = {
  tr: {
    ...
    hero: {
      ...
      quote: "Geleceği tahmin etmenin en iyi yolu, onu kendi ellerinle inşa etmektir.",
      subtitle: "Rehberlik ve Psikolojik Danışmanlık (RPD) uzmanlığıyla; öğrencilere stratejik sınav koçluğu, bireylere bilimsel temelli psikolojik destek sunuyorum. İlk tanışma ve ihtiyaç analizi görüşmesi yaklaşık 20 dakika ve tamamen ücretsizdir.",
      cta: { free: "20 Dk Ücretsiz Tanışma", packages: "Paketleri İncele", whatsapp: "WhatsApp'tan Yazın" },
      scroll: "Keşfet",
      dailyCta: "Oku",
    },
    discover: {
    ...
    about: {
      ...
      para1: "Muş Alparslan Üniversitesi Rehberlik ve Psikolojik Danışmanlık (RPD) lisans programından 2022 yılında mezun oldum. Bilimsel psikolojik danışmanlık formasyonumu, sınav ve öğrenci koçluğunun stratejik metotlarıyla birleştirerek sunuyorum.",
      para2: "Hâlihazırda Çanakkale'de aktif olarak rehber öğretmen / psikolojik danışman olarak görev yapıyor; hem yüz yüze hem de Türkiye geneli online olarak bireysel danışmanlık ve sınav koçluğu seanslarımı sürdürüyorum.",
      features: [
        "Sınav Koçluğu (YKS / LGS)",
        "Öğrenci Koçluğu & Çalışma Stratejileri",
        "Bireysel Psikolojik Danışmanlık",
        "Online Koçluk ve Seanslar",
        "Oyun Terapisi (Çocuk Odaklı)",
    ...
    services: {
      ...
      subtitle: "Akademik başarı ve psikolojik denge birbirinden bağımsız değildir; birbirini sürekli besler. Hangi alandan başlarsanız başlayın, bilimsel ve bütüncül bir yaklaşımla karşılanırsınız.",
      groups: [
        {
          key: "academic",
          eyebrow: "Alan 01 — Akademik Destek & Koçluk",
          heading: "Sınava ve okula dair her şey",
          blurb: "Hedefi olan öğrenci için: stratejik planlama, doğru öğrenme yöntemleri, haftalık takip ve güçlü motivasyon. Koçluk özel ders değildir; ders anlatmaz, nasıl çalışılacağını öğretir ve sınav maratonunu baştan sona profesyonelce yönetir.",
          items: [
            {
        ...
        },
        {
          ...
          blurb: "RPD uzmanlığıyla yürütülen bilimsel danışmanlık ve terapi çalışmaları. İlk görüşmede ihtiyaçlarınızı birlikte değerlendirir, size en uygun yöntem ve takvimi birlikte belirleriz.",
          items: [
            {
      ...
      packages: {
        ...
        subtitle: "Akademik destek ve psikolojik danışmanlık ayrı yürütülür ama birbirini besler. Hangisiyle başlarsanız başlayın, ilk 20 dakikalık tanışma görüşmesi ücretsizdir.",
        note: "Kontenjan sınırlıdır; her öğrenci ve danışanla yüksek odak ve düzenli çalışabilmek için aynı anda kabul edilen danışan sayısı kısıtlı tutulur.",
        ...
        items: [
          {
            key: "kocluk",
            badge: "Sınav & Öğrenci Koçluğu",
            title: "Koçluk Paketi",
            desc: "Hedefi olan öğrenciye plan, yöntem ve düzenli takip sağlar. Ders anlatmaz; nasıl çalışılacağını öğretir ve sınav maratonunu baştan sona profesyonelce yönetir.",
            meta: ["YKS, LGS ve Ara Sınıflar", "Yüz yüze (Çanakkale) + Online", "20 dk ücretsiz tanışma"],
            includes: [
              "Bireysel hedefler belirlenir, kişiye özel haftalık çalışma programı hazırlanır.",
              "Denemeler soru soru analiz edilir, netler ve ilerleme haftalık takip edilir.",
              "Zaman yönetimi, soru çözme stratejileri ve verimli çalışma teknikleri kazandırılır.",
              "Sınav kaygısı ve motivasyon dalgalanmaları psikolojik altyapıyla yönetilir.",
              "Ebeveynle düzenli aylık değerlendirme yapılarak ev içi iletişim rahatlatılır.",
            ],
            price: "7.000 ₺",
            priceUnit: "aylık",
          ...
          },
          {
            ...
            desc: "RPD formasyonu ve bilimsel ekollerle yürütülen birebir danışmanlık ve terapi çalışmalarını kapsar. Süreç ve sıklık, ilk görüşmede birlikte planlanır.",
            meta: ["Çocuk, genç ve yetişkin", "Yüz yüze + Online", "20 dk ücretsiz tanışma"],
            includes: [
              "İlk tanışma görüşmesinde temel ihtiyaçlar ve hedefler birlikte netleştirilir.",
              "Kaygı, stres, özgüven ve yaşam dönüm noktaları üzerine yapılandırılmış çalışma.",
              "Çocuklarda davranış ve duygu regülasyonu için oyun terapisi.",
              "Aile içi iletişim örüntüleri ve ebeveyn danışmanlığı görüşmeleri.",
            ],
            confidentialityNote: "Tüm görüşmeler Türk PDR Derneği etik standartları çerçevesinde kesinlikle gizlidir; içerik üçüncü kişilerle asla paylaşılmaz.",
            priceNote: "Ücret, seans periyodu ve ihtiyaca göre ilk görüşmede belirlenir.",
    ...
    process: {
      ...
      subtitle: "İlk adımdan itibaren sizi desteklemek için yapılandırılmış, şeffaf ve bilimsel bir yol haritası izliyorum.",
      steps: [
        {
          title: "İlk İletişim",
          desc: "WhatsApp üzerinden veya formu doldurarak bana ulaşın. Aynı gün içinde doğrudan ben dönüş sağlıyorum.",
        },
        {
          title: "20 Dk Ücretsiz Tanışma",
          desc: "Yaklaşık 20 dakikalık ücretsiz görüşmemizde mevcut durumu analiz ediyor, size en uygun koçluk veya danışmanlık planını konuşuyoruz.",
        },
        {
          title: "Stratejik Yol Haritası",
          desc: "Öğrencinin veya danışanın hedeflerine göre kişiye özel haftalık çalışma takvimi ve seans hedeflerini netleştiriyoruz.",
        },
        {
          title: "Düzenli Seans ve Takip",
          desc: "Düzenli birebir seanslar, deneme analizleri ve kesintisiz motivasyon takibiyle hedeflere emin adımlarla ilerliyoruz.",
        },
      ],
    },
    whoFor: {
      ...
      subtitle: "Her öğrencinin potansiyeli ve çalışma dinamiği farklıdır. Aşağıdaki durumlardan birini yaşıyorsanız koçluk tam size göre:",
      profiles: [
        {
          title: '"Çalışıyorum Ama Olmuyor" Diyenler',
          desc: "Masa başında saatler harcayıp deneme netlerini artıramayan öğrenciler. Koçluk; ezbere değil, bilişsel öğrenme ve aktif hatırlama teknikleriyle netlerinizi yükseltir.",
        },
        {
          title: "Sınav Kaygısı ve Panik Yaşayanlar",
          desc: "Bildiği soruları sınav anında heyecandan yapamayan, zamanı yetiştiremeyen öğrenciler. BDT temelli psikolojik tekniklerle sınav soğukkanlılığı kazandırılır.",
        },
        {
          title: "Zaman Yönetimi ve Erteleme Sorunu Olanlar",
          desc: "Ders çalışmayı sürekli erteleyen, neye nereden başlayacağını bilemeyen, okul-kurs-sosyal yaşam dengesini oturtamayan öğrenciler.",
        },
        {
          title: "Motivasyon Dalgalanması Yaşayanlar",
          desc: "Birkaç denemede başarısız olunca pes eden, hedefini kaybeden ya da uzun sınav maratonunda tükenmişlik hisseden adaylar.",
        },
        {
          title: "Evde 'Ders Çalış' Kavgası Yaşayan Aileler",
          desc: '"Hadi ders çalış" demenin evde her akşam krize dönüştüğü, ebeveynin denetçi olmaktan yorulup destekçi olmak istediği aileler. Koçluk bu sorumluluğu öğrenciye devrederek aile içi huzuru geri kazandırır.',
        },
      ],
    },
    testimonials: {
      ...
      items: [
        {
          ...
          a: "Koçluk hedef odaklıdır; akademik başarı, sınav hazırlığı, verimli ders çalışma ve zaman yönetimine odaklanır. Psikolojik danışmanlık ise duygusal ve ruhsal denge odaklıdır; kaygı, özgüven, stres ve duygusal güçlüklerde bilimsel terapi yöntemleriyle çalışılır. RPD lisans mezunu olarak her iki alanda da yetkinlikle destek sağlıyorum.",
        },
        {
          q: "Koçluk sürecine veliler nasıl dahil ediliyor?",
          a: "Koçluk öğrenci ile birebir yürütülür; ancak veli asla sürecin dışında bırakılmaz. Belirli aralıklarla yaptığımız veli bilgilendirme görüşmeleriyle öğrencinin gelişimini paylaşıyor, evdeki ders çalışma çatışmalarını önleyecek sağlıklı ebeveyn tutumları konusunda rehberlik ediyorum.",
        },
        {
          q: "Seanslar ne kadar sürer?",
          a: "Koçluk seansları 45-50 dakika, psikolojik danışmanlık seansları ise 50 dakikadır. İlk tanışma görüşmesi yaklaşık 20 dakika sürer ve tamamen ücretsizdir.",
        },
        {
          q: "Online koçluk yüz yüze kadar etkili mi?",
          a: "Kesinlikle evet. Yapılan bilimsel araştırmalar ve öğrenci geri bildirimlerimiz, dijital takip araçları ve görüntülü seanslarla yürütülen online koçluğun yüz yüze seanslar kadar yüksek verim sağladığını göstermektedir.",
        },
        {
          q: "Kaç seansta sonuç alabilirim?",
          a: "Öğrencinin mevcut durumuna göre değişmekle birlikte, düzenli takip ve program disipliniyle genellikle 4-6 hafta içerisinde çalışma alışkanlıklarında ve deneme netlerinde belirgin ilerleme gözlemlenir.",
        },
        {
        ...
        {
          q: "Psikolojik danışmanlık seansları gizli midir?",
          a: "Evet. Tüm danışmanlık süreçleri Türk PDR Derneği etik ilkeleri ve danışan gizliliği kurallarına harfiyen bağlı kalınarak yürütülür. Kişisel paylaşımlarınız üçüncü şahıslara asla aktarılmaz.",
        },
        {
          q: "İlk görüşme gerçekten ücretsiz mi?",
          a: "Evet, 20 dakikalık ilk tanışma görüşmesi tamamen ücretsizdir. Bu görüşmede durumunuzu analiz eder, size en uygun çalışma planını birlikte kararlaştırırız.",
        },
      ],
    },
    contact: {
