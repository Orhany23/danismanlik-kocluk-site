      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
          ...
          <Section title="8. Psikolojik Testler">
            ...
            <p>
              Bu testler klinik tanı aracı değildir. Ekranda sadece ham puanını görürsün; yorumu
              gösterilmez, bir sonraki danışmanlık görüşmesinde seninle birlikte yapılır. Test
              geçmişinin silinmesini talep edebilirsin.
            </p>
          </Section>
...
function Section({ id, title, children }: { id?: string; title: string; children: React.ReactNode }) {
  return (
    // scroll-mt: footer'daki "/gizlilik#cerezler" bağlantısında başlık
