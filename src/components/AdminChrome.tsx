...
import {
  ...
  Inbox, BookOpen, Star, Settings, LogOut, Menu, X, ExternalLink, BarChart3, ListChecks,
  BrainCircuit,
} from "lucide-react";
...
const sidebarLinks = [
  ...
  { href: "/admin/klinik-rehber", label: "Klinik Rehber", icon: BrainCircuit },
  { href: "/admin/mufredat", label: "Konu Takibi", icon: ListChecks },
